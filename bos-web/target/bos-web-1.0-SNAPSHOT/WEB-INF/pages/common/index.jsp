    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnEp").click(function () {
                var b =  $("#editPwdFrom").form("validate");
                if(b) {
                    var pwd1 = $("#txtNewPass").val();
                    var pwd2 = $("#txtRePass").val();
                    if(pwd1 == pwd2) {
                        //两次密码输入一致发送请求
                            $.post("${pageContext.request.contextPath}/userAction_editPass",{"password":pwd1},function (data) {
                            if (data=='1') {
                                $("#editPwdWindow").window("close");
                            }else {
                        ...
                        $.messager.alert("提示信息", "两次输入的密码不一致！", "wrring");
                    }
                }
            });
        });
